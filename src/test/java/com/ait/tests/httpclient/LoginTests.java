...
public class LoginTests {
    ...
    public void loginPositiveTest() throws IOException {
        ...
        String email = "nbo007@gmail.com";
        String password = "Olna123488$";
    ...
    // другой вариант (лучший)
      @Test
    public void loginPositiveTestWithData() throws IOException {   //используем DTO


          AuthRequestDto requestDto = AuthRequestDto.builder()
                  .username("nbo007@gmail.com")
                  .password("Olna123488$")
                  .build();
      ...
      @Test
    public void loginNegativeWrongPasswordTestWithData() throws IOException {   //используем DTO
